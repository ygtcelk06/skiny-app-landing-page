      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        >
          ...
          <div className="space-y-6 text-gray-700">
            <p>
              6698 sayılı Kişisel Verilerin Korunması Kanunu ("KVKK") uyarınca, Klaris isimli mobil uygulama kapsamında sunulan cilt analizi hizmetinden yararlanabilmem için aşağıda belirtilen kişisel verilerimin işlenmesine, aktarılmasına ve saklanmasına açıkça rıza verdiğimi kabul ve beyan ederim:
            </p>
